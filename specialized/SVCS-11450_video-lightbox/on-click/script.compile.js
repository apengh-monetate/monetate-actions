...
(function () {
  ...
  pollForElement('.mt-lightbox__video', function () {
    // Get all lightboxes
    var lightboxes = document.querySelectorAll('#monetate_lightbox'); // Loop through them, see if it has our .mt-lightbox__video element
    ...
    function stopVideo(element) {
      console.log('STOP PLAYBACK'); // element.src = '';
