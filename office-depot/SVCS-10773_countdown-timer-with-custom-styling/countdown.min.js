...
t.checkValue(t.values.seconds,c,l),--t.total_seconds):(clearInterval(t.countdown_interval),document.querySelector(".countdown").classList.remove("active"),document.querySelector(".countdown").classList.add("expired"),document.querySelector(".countdown__expired").classList.add("active"))},1e3)},animateFigure:function e(t,s){
//var that         = this,
var o=t.querySelector(".top"),i=t.querySelector(".bottom"),n=t.querySelector(".top-back"),u=t.querySelector(".bottom-back");// Before we begin, change the back value
n.querySelector("span").innerHTML=s,// Also change the back bottom value
u.querySelector("span").innerHTML=s,// Animate
-1!==navigator.userAgent.indexOf("MSIE")||-1<navigator.appVersion.indexOf("Trident/")?(
/* Microsoft Internet Explorer detected in. */
o.innerHTML=s,i.innerHTML=s):(o.classList.add("flipTop"),setTimeout(function(){o.classList.remove("flipTop"),o.innerHTML=s},750),n.classList.add("flipTopBack"),setTimeout(function(){n.classList.remove("flipTopBack"),i.innerHTML=s},750))},checkValue:function e(t,s,o){var i=t.toString().charAt(0),n=t.toString().charAt(1),u=s.querySelector(".top").innerHTML,a=o.querySelector(".top").innerHTML;10<=t?(
