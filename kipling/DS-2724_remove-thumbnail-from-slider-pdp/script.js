(function() {
    ...
    pollForElements(['.product-gallery.slick-initialized', '.product-gallery-thumbnails.slick-initialized'], function(nodes) {
        ...
        var $thumbnailSlider = $('.product-gallery-thumbnails.slick-initialized');

        // Get the settings for each slider
        var productSettings = $productSlider.slick('getSlick').originalSettings;
        var thumbnailSettings = $thumbnailSlider.slick('getSlick').originalSettings;

        // Destroy each slider
        $productSlider.slick('unslick');
        $thumbnailSlider.slick('unslick');

        // Remove the element from the thumbnail slider
        var $thumbnail = $thumbnailSlider.find('div.image.js-is-spin');
        $thumbnail.remove();

        // Remove the element from the main product slider
