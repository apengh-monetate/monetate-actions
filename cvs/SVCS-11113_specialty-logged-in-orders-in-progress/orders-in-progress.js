(function() {
  ...
  function moveOrdersInProgress() {
    var $content = document.querySelector('.mt-oip__content');

    // Loop through active prescriptions
  ...
  var selector = '.prescription-list-container > .prescription-list';
  pollForElement(selector, function() {
    if (!elementExists('.mt-oip')) {
      insertHTML(selector, 'beforebegin');
      moveOrdersInProgress();
      var ordersInProgressCount = document.querySelector('.mt-oip__content').childElementCount;
