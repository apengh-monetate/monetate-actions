...
var opt_delimiter = '_';
var opt_linkTrackEvents; // translate array of objects into array of strings
...
var submitToSiteCat = function submitToSiteCat(accountId, varKey, opt_linkTrackEvents, opt_delimiter) {
...
var pollForSiteCat = function pollForSiteCat(successHandler, imgKey, opt_accountId) {
  console.group('pollForSiteCat');

  var pageViewComplete = function pageViewComplete() {
    console.log('imgKey', imgKey);
  ...
  pollingFunction(50, 10000, function () {
    // every 50ms for 10s
    ...
    console.log('pageViewComplete', _typeof(pageViewComplete()));
