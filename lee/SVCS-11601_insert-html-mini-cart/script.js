(function() {
    console.log('MOUSE OVER MINI-CART');
...
var t = this;
t.isSmallScreen ? (t.toggleOverlay(),
t.$globalCartWishlistPanels.find(".notification").removeClass("hide"),
t.$globalCartWishlistPanels.removeClass("hide"),
t.isTopMiniCart || t.$globalCartWishlistPanels.show(),
$("html,body").animate({
    scrollTop: 0
}, "fast")) : (t.$globalCartWishlistPanels.show(),
t.$globalCartWishlistPanels.removeClass("hide"))
