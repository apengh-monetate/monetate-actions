...
(function () {
  console.log('Synchronize sliders'); // Synchronize sliders

  var header = document.querySelector('#main-global-stripe-select'); // Poll for element
  ...
  pollForElement('#promo-strip-carousel div[id*="mt-slider"]', function () {
    ...
    pollForElement('#promo-carousel div[id*="mt-slider"]', function () {
      var collapsibleCarousel = document.querySelector('#promo-carousel div[id*="mt-slider"]'); // Prev Arrow Click
