(function() {
    ...
    var altImageRegex = new RegExp('\d*\_alt1', 'g');


    // Polling function
    var poll = function(isReady, onReady) {
    ...
    var getIndexThumbnails = function() {
        var thumbnails = [];
